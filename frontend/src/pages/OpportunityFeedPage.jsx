    ...
    <div className={`sdDashboardWrapper ${isDarkMode ? "dark-theme" : ""}`}>
      ...
      <div className="sdMainContainer">
        ...
        <div className="ofpRightBodyArea">
          ...
          {/* ── 2-COLUMN MAIN WORKSPACE (LEFT PORTALS + RIGHT WIDGETS) ── */}
          <div className="jspMainGridContainer">
            ...
            <div className="jspLeftContentCol">
              ...
              {/* BOTTOM ROW: Application Tracker + Resume Score */}
              <div className="jspBottomGridRow" style={{ marginTop: "32px" }}>
                
                {/* APPLICATION TRACKER STEPPER */}
                <div className="jspTrackerCard">
                  <div className="jspTrackerHeader">
                    <h3>Application Tracker</h3>
                    <button className="jspViewApplicationsBtn" onClick={() => setMyApplicationsModal(true)}>
                      View All ({appliedList.length}) &rarr;
                    </button>
                  </div>

                  <div className="jspStepperPipeline">
                    <div className="jspStepNode completed">
                      <div className="jspNodeCircle green">✓</div>
                      <span className="nodeTitle">Applied</span>
                      <strong className="nodeVal">{appliedList.length}</strong>
                    </div>

                    <div className="jspStepLine" />

                    <div className="jspStepNode active">
                      <div className="jspNodeCircle blue">6</div>
                      <span className="nodeTitle">Shortlisted</span>
                      <strong className="nodeVal">6</strong>
                    </div>

                    <div className="jspStepLine" />

                    <div className="jspStepNode">
                      <div className="jspNodeCircle yellow">7</div>
                      <span className="nodeTitle">Online Assessment</span>
                      <strong className="nodeVal">7</strong>
                    </div>

                    <div className="jspStepLine" />

                    <div className="jspStepNode">
                      <div className="jspNodeCircle purple">4</div>
                      <span className="nodeTitle">Interview</span>
                      <strong className="nodeVal">4</strong>
                    </div>

                    <div className="jspStepLine" />

                    <div className="jspStepNode">
                      <div className="jspNodeCircle pink">2</div>
                      <span className="nodeTitle">HR Round</span>
                      <strong className="nodeVal">2</strong>
                    </div>

                    <div className="jspStepLine" />

                    <div className="jspStepNode">
                      <div className="jspNodeCircle offer">1</div>
                      <span className="nodeTitle">Offer</span>
                      <strong className="nodeVal">1</strong>
                    </div>
                  </div>
                </div>

                {/* RESUME SCORE CARD */}
                <div className="jspResumeScoreCard">
                  <div className="jspResumeDonutWrapper">
                    <svg viewBox="0 0 60 60" className="jspDonutSvg">
                      <circle cx="30" cy="30" r="22" className="bgCircle" />
                      <circle cx="30" cy="30" r="22" className="fillCircle" strokeDasharray="138" strokeDashoffset={138 - (138 * 91) / 100} />
                    </svg>
                    <span className="donutValText">91%</span>
                  </div>

                  <div className="jspResumeScoreInfo">
                    <span className="scoreLabel green">Excellent</span>
                    <p className="scoreSub">Your resume is recruiter ready!</p>
                    <button className="jspImproveResumeBtn" onClick={() => navigate("/resume-builder")}>
                      Improve Resume
                    </button>
                  </div>
                </div>
            ...
            {/* RIGHT SIDEBAR WIDGETS COLUMN (1-TO-1 MATCH TO MOCKUP) */}
            <aside className="jspRightSidebarCol">
              
              {/* WIDGET 1: Job Summary */}
              <div className="jspWidgetCard">
                <h4 className="jspWidgetTitle">
                  <FaBriefcase color="#f97316" /> Job Summary
                </h4>

                <div className="jspSummaryList">
                  <div className="summaryItem">
                    <span className="iconBox orange">💼</span>
                    <div className="summaryInfo">
                      <strong className="val">150+</strong>
                      <span className="lbl">Jobs Found</span>
                    </div>
                  </div>

                  <div className="summaryItem">
                    <span className="iconBox green">❇️</span>
                    <div className="summaryInfo">
                  ...
                  <div className="summaryItem">
                    ...
                    <div className="summaryInfo">
                      <strong className="val">{appliedList.length}</strong>
                      <span className="lbl">Applied</span>
                    </div>
                  </div>

                  <div className="summaryItem">
                    <span className="iconBox purple">👤</span>
                    <div className="summaryInfo">
              ...
              <div className="jspWidgetCard">
                <div className="jspWidgetHeaderRow">
                  <h4 className="jspWidgetTitle">
                    <FaClock color="#ef4444" /> Upcoming Deadlines
                  </h4>
                  <button className="jspWidgetLinkBtn" onClick={() => setToastMessage("All application deadlines listed.")}>
                    View All Deadlines &rarr;
                  </button>
                </div>

                <div className="jspDeadlinesList">
                  {upcomingDeadlines.map((d, idx) => (
                    <div key={idx} className="deadlineItem">
                      <div className="dIcon" style={{ background: d.logoBg }}>❖</div>
                      <div className="dInfo">
                        <strong className="title">{d.title}</strong>
                        <span className="timeRed">{d.daysLeft}</span>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              {/* WIDGET 5: Need Referrals? Community Banner */}
              <div className="jspReferralsDarkBanner">
                <div className="bannerTextCol">
                  <h3>Need referrals?</h3>
                  <p>
                    Join SkillSphere Career Community. Get referrals, insider tips and faster responses.
                  </p>
                  <button
                    className="jspJoinCommunityBtn"
                    onClick={() => setShowJoinCommunity(true)}
                  >
                    Join Community &rarr;
                  </button>
                </div>
                <div className="bannerAvatarsGraphic">
                  👥
                </div>
              </div>
